...
local communityLines = {
	{
		...
		"Home",
		function ()
			WG.BrowserHandler.OpenUrl("https://www.evolutionrts.info/")
		end
	},
	{
		"Community forums.",
	...
	},
	{
		...
		"Youtube",
		function ()
			WG.BrowserHandler.OpenUrl("https://www.youtube.com/user/EvolutionRTSGame")
		end
	},
	{
		"Discord chat server.",
	...
	},
	{
		...
		"Source",
		function ()
			WG.BrowserHandler.OpenUrl("https://github.com/EvolutionRTS/Evolution-RTS")
		end
	},
	{
		...
		"Report bug",
		function ()
			WG.BrowserHandler.OpenUrl("https://github.com/EvolutionRTS/Evolution-RTS/issues/new")
		end
	},
	{
